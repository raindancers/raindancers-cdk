  ...
  constructor(scope: Construct, id: string, props: ImagePipelineProps) {
    ...
    if (props.amiIdSsmPath) {
      ...
      const amiSsmUpdateLambda = new lambda.Function(this, 'UpdateLambda', {
        ...
        code: lambda.Code.fromAsset(path.join(__dirname, '../../assets/imagebuilder/')),
      ...
      amiSsmUpdateLambda.addEventSource(new lambda_event_sources.SnsEventSource(this.builderSnsTopic, {}));
    }
